...
class HomeViewModel @Inject constructor(
    ...
    fun loadWeatherForSavedCity() {
        // 1. Получаем полную строку из памяти (например, "Moscow, Russia")
        val fullLocation = settingsRepository.getCity()

        // 2. Парсим строку: берем всё до первой запятой и удаляем лишние пробелы.
        ...
        // 3. Вызываем метод запроса в сеть с уже отформатированным названием
